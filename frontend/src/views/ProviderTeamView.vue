      ...
      <dialog class="mp-dialog" :open="showAddDialog">
        <div class="mp-dialog__panel">
          <div class="mp-dialog__head">
            ...
            <button type="button" class="btn btn-ghost" @click="closeAdd">Close</button>
          </div>

          <p v-if="!canManageTeam" class="muted small">You do not have permission to create or edit staff.</p>
          ...
          <FormField label="Permissions">
            <div class="perm-grid">
              <label v-for="k in grantablePermissionOptions" :key="k" class="perm-item">
                <input type="checkbox" :value="k" v-model="newStaff.permissions" :disabled="!canManageTeam" />
                <span>{{ k }}</span>
              </label>
            </div>
            <p class="muted small">Tick each permission to add it.</p>
          </FormField>

          <div class="mp-dialog__actions">
            <button type="button" class="btn btn-primary" :disabled="!canManageTeam" @click="createStaff">Create staff</button>
